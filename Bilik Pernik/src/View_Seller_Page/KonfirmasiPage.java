...
public class KonfirmasiPage extends javax.swing.JFrame {
    ...
    private void Masuk_TombolMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Masuk_TombolMouseClicked
        ...
        new Seller_Login_Page(Nama, Mail).setVisible(true); /*Deklarasi variabel pada form yang ingin dituju dan variabel tersebut menunjukkan nilai yang sama dengan form yang ingin dituju*/
